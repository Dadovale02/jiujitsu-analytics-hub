export const teamsData = [
  {
    ...
    achievements: [
      ...
      "Multiple ADCC World Championship Medals",
      "Numerous Pan American and European Open Titles"
    ],
    distinctiveTechniques: "Atos is known for their aggressive guard passing, innovative leg lock systems, and strong wrestling-based takedowns.",
    affiliatedAcademies: [
      { name: "Atos HQ", location: "San Diego, California" },
      { name: "Atos Rio de Janeiro", location: "Rio de Janeiro, Brazil" },
      { name: "Atos São Paulo", location: "São Paulo, Brazil" }
    ],
    socialMedia: {
      instagram: "atosjiujitsuhq",
      facebook: "atosjiujitsuofficial",
      twitter: "atosjiujitsu"
    },
  ...
  },
  {
    ...
    distinctiveTechniques: "Gracie Barra is known for their strong fundamentals, effective self-defense techniques, and a balanced approach to both gi and no-gi jiu-jitsu.",
    affiliatedAcademies: [
      { name: "Gracie Barra HQ", location: "Irvine, California" },
      { name: "Gracie Barra Rio de Janeiro", location: "Rio de Janeiro, Brazil" },
      { name: "Gracie Barra Belo Horizonte", location: "Belo Horizonte, Brazil" }
    ],
    socialMedia: {
      instagram: "graciebarra",
      facebook: "GracieBarraOfficial",
      twitter: "graciebarra"
    },
